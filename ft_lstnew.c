...
/*   Updated: 2024/05/27 10:51:35 by athonda          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * @param[in]	content the pointer to be set in the list box
 * @return pointer to the beginning of the list
 * @sa malloc
 * @note set NULL in the next member. its used for linking to other box
*/
